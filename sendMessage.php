...
mysql_close($connenction_link);
          ...
          if (   $_SESSION["type"] == 0 ) 
          header("Location: home.html?msg=7");

          if (   $_SESSION["type"] == 1 ) 
          header("Location: home(Teacher).html?msg=7");
...
?>  
        ...
        <form class="" method="post" action="sendMessage.php">
             	<input type="email" name="Email" required  placeholder="إيميل المرسل إليه" />
        		 <br><br>
