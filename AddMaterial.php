...
mysql_close($connenction_link);
  ...
  header("Location: Home(Teacher).html?msg=5");

}
else{

  echo "   <h2> هذه المادةليست موجودة </h2>";
}

}
 
?>      
             	<form class="" method="post" action="AddMaterial.php">
        	   	<input type="text"  name="CourseName" required placeholder="إسم المادة" />
				<br>
        	
         
         		<input type="text"  name="lessonNum" required placeholder="رقم الدرس" />
				<br>
        		<input type="text"  name="Images"  placeholder="صورة للدرس" />
				<br>
        		<input type="text"  name="Videos"  placeholder="فيديو للدرس" />
				<br>
				<br><br>
				<textarea name="lesson" required col="200" rows="20" /> </textarea >
        	<input type="submit" name="submit" value="أضف الدرس" />
        	</form>
        </div>
